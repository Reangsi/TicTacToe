	...
	public void checkForTwoInARow() {
		...
		if ((spielfeld[1][0] == player && spielfeld[1][1] == player)) {
			spielfeld[1][2] = computer;
															...
															// Die ganze Logik darin besteht daraus, dass wenn der Spieler zuerst in die mitte Setzt
															// , dass der Computer dann in eine Ecke setzt, da er sonst verlieren könnte. Nach den ersten 
															// Schritten, die bestimmt sind, wird einfach die checkForTwoInRow Methode angewendet.														
